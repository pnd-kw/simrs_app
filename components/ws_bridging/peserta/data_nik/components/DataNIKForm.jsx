...
import { useDataNIKStore } from "@/stores/ws_bridging/useWsBridgingStore";
        ...
        <div className="w-full h-full p-4 mx-auto">
          <form onSubmit={handleSubmit(onSearch)}>
            <div className="grid grid-cols-2 w-full gap-2 p-2">
              <div>
                <label className="text-xs uppercase">Nik ktp</label>
                <Input
                  type="text"
                  placeholder="NIK KTP"
                  {...register("nik")}
