...
const mappedData = (data) =>
  data.map((item) => ({
    ...
    data_source: "table igd",
  }));

const SearchKunjunganIgd = () => {
                        ...
                        <Popover open={open} onOpenChange={setOpen}>
                          <PopoverTrigger asChild>
                            <Button
                              ...
                              style={{ fontSize: 12 }}
                            >
                              <span className="max-w-40 truncate whitespace-nowrap overflow-hidden text-ellipsis">
...
export default SearchKunjunganIgd;
