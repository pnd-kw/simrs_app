...
} from "./PekerjaanFields";
import Spinner from "@/utils/spinner";

const PenanggungJawabComp = () => {
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    resolver: zodResolver(penanggungJawabSchema),
    defaultValues: {
      name: "",
    },
  });
  ...
  const fields = getPenanggungJawabFields();
  ...
  const filteredPekerjaan = formattedData.filter((item) => {
    const searchLower = searchPekerjaan.toLowerCase();
    ...
    <>
      {isLoading ? (
        ...
        <div className="p-2 mx-auto">
          ...
          <Table
            data={searchPekerjaan ? filteredPekerjaan : formattedData}
...
export default PenanggungJawabComp;
